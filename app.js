...
let draft=JSON.parse(localStorage.getItem('apm_draft')||'null')||{
 ...
 imovel:{tipo:'Apartamento',condominio:'',logradouro:'',numero:'',complemento:'',bairro:'',cidade:'Manaus',uf:'AM',cep:'',matricula:'',cartorio:'',inscricao:'',areaEscolhida:''},
...
const testExtractions={
  ...
  'wallet_RG-DIGITAL.pdf':{type:'CIN',confidence:'Alta',fields:[
    ['Nome','SAMARA GABRIELLE DOS SANTOS VIEIRA CORREIA','CIN'],['CPF','020.699.262-90','CIN'],['Nascimento','04/07/2005','CIN'],['Nacionalidade','BRASILEIRA','CIN'],['Naturalidade','MANAUS/AM','CIN'],['Estado civil','Solteiro(a)','CIN']
...
function applyExtractionToDraft(out,role,notify=true){
  ...
  if(role==='Vendedor'||role==='Comprador'){
    ...
    if(by.descricao && !x.logradouro)x.logradouro=by.descricao;
